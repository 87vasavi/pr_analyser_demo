...
def test_create_task_with_valid_description():
    response = client.post("/tasks", params={"title":"new_task", "description": "A valid task description."})
...
def test_create_task_with_long_description():
    ...
    response = client.post("/tasks", params={"title":"new_task", "description": long_description})
